...
namespace GraphicLine
{
    public partial class GraphicLine : UserControl
    {
        ...
        private void GraphicLine_Paint(object sender, PaintEventArgs e)
        {
            ...
            #region drawing metric grid

            color1 = Color.FromArgb(0, 0, 0);
            pen1 = new Pen(color1);
            pen1.Width = 1;
            for (int i = this.GraphicLineY2- this.MaxYAxisValue; i > 0; i -= this.MaxYAxisValue)
            {
                //.Graphics.DrawLine(pen1, this.GraphicLineX1, i, this.GraphicLineX2, i);
            }
